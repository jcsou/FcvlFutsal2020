...
<div class="container-fluid">
  ...
  <div class="row">
    <div class="col-lg-6 col-md-12">
      ...
      <div class="card">
        <div class="card-header card-header-info">
          <h4 class="card-title">U9 - Phase Finale - Les Matchs <button @click="update()" class="btn btn-default pull-right " style="height=15px;"><i _ngcontent-pro-c19="" class="material-icons icon-image-preview">loop</i></button></h4> 
        </div>
    ...
    <div class="col-lg-6 col-md-12">
      ...
      <div class="card">
        <div class="card-header card-header-info">
          <h4 class="card-title">U9 - Classement G&eacute;n&eacute;rale </h4>
        </div>
        <div class="card-body table-responsive">
          <table class="table table-hover">
            <thead class="text-info">
